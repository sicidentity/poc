      ...
      <View className="flex-1">
        ...
        {verificationStatus === 'success' && (
          <View className="items-center px-6">
            ...
            <Text className="text-green-500 text-lg font-medium mb-2 mt-4">Verified</Text>
            <Pressable 
        ...
        {verificationStatus === 'error' && (
          <View className="items-center px-6">
            ...
            <Text className="text-red-500 text-lg font-medium mb-2 mt-4">Invalid QR Code</Text>
            <Pressable 
              className="bg-black rounded-full py-3 px-6 w-full items-center mt-4"
              onPress={() => {
                setScanned(false);
